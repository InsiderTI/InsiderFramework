...
class RouteData
{
    ...
    public function executeRoute(): void
    {
        ...
        $C = \Modules\InsiderFramework\Core\Loaders\CmLoader::controller(
            $this->getApp() . "\\" . $this->getController(),
            $this->getParamsArray()
        );
            ...
            switch (strtolower($permissionsOfRoute['type'])) {
                ...
                case "custom":
                    ...
                    \Modules\InsiderFramework\Core\FileTree::requireOnceFile(
                        ...
                        'sys' . DIRECTORY_SEPARATOR . 'controllers' . DIRECTORY_SEPARATOR .
                        'security_controller.php'
                    );
                    $Sec_security = new \Controllers\sys\SecurityController('insiderFrameworkSystem', null);
